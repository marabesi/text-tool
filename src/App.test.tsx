...
describe('json utility', () => {
  ...
  describe('UI elements', () => {
    ...
    it('should render github link', () => {
      ...
      expect(screen.queryByText(/by marabesi/)).toHaveAttribute('href', 'https://github.com/marabesi/text-tool');
    ...
    it('should render license link', () => {
      ...
      expect(screen.queryByText(/CC0 1.0 Universal/)).toHaveAttribute('href', 'https://github.com/marabesi/text-tool/blob/main/LICENSE.md');
